...
${OBJECTDIR}/_ext/1472/BaseApplication.o: ../BaseApplication.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/OGRE -I/usr/include/OIS -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/BaseApplication.o ../BaseApplication.cpp

${OBJECTDIR}/_ext/1472/BasicTutorial05.o: ../BasicTutorial05.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -I/usr/include/OGRE -I/usr/include/OIS -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/BasicTutorial05.o ../BasicTutorial05.cpp
